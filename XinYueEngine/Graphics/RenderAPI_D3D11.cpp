...
void RenderAPI_D3D11::UpdateStereoEnabledStatus()
{
...
void RenderAPI_D3D11::UpdateForWindowSizeChange()
{
...
void RenderAPI_D3D11::HandleDeviceLost()
{
...
void RenderAPI_D3D11::CreateDeviceResources()
{
...
void RenderAPI_D3D11::CreateWindowSizeDependentResources()
{
   ...
   // avoid rebuilding everything if the size is identical.
	...
	else    // Otherwise, create a new one.
	{
		...
		swapChainDesc.Width = m_Resolution.w;                                     // Use automatic sizing.
...
void RenderAPI_D3D11::SetDpi(float dpi)
{
...
void RenderAPI_D3D11::SetStereoExaggeration(float Factor)
{
	Factor = min(Factor, 4.0f);
	Factor = max(Factor, -4.0f);
	m_stereoExaggerationFactor = Factor;
...
void RenderAPI_D3D11::OnKeyDown(UINT8 key)
{


}
void RenderAPI_D3D11::OnKeyUp(UINT8 key)
{
...
void RenderAPI_D3D11::CreateVertexBuffer(
...
void RenderAPI_D3D11::CreateIndexBuffer(
...
void RenderAPI_D3D11::CreatePlane(ID3D11Buffer ** vertexBuffer, ID3D11Buffer ** indexBuffer, unsigned int * vertexCount, unsigned int * indexCount, float	frustumWidth, float	frustumHeight)
{
...
bool RenderAPI_D3D11::InitializeShader(ID3D11Device* device, HWND hwnd,const WCHAR* vsFilename, const WCHAR* psFilename)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "vert", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, "frag", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
...
void RenderAPI_D3D11::OnStart()
{
 ...
 void RenderAPI_D3D11::RenderEye(int eyeIndex)
{
...
void RenderAPI_D3D11::SetFullScreen()
{
...
void RenderAPI_D3D11::ExitFullScreen()
{
	if (m_SwapChain == NULL)return;
	// Detect if newly created full-screen swap chain isn't actually full screen.
	IDXGIOutput* pTarget; BOOL bFullscreen;
